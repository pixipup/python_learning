...
popped_element = new_list.pop() #delete or pop the last element of the list
print(popped_element)
#Note:- In the above example, creating a new variable resulted in using of original 'new_list" & not the modified ones.
